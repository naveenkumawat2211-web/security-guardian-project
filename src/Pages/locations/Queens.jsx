...
import queensBanner from '../../assets/Locations/queens.jpg'
            ...
            <section className="relative h-[520px] overflow-hidden">
                ...
                <div data-aos="zoom-in" className="relative z-10 flex items-center justify-center h-full px-5">
                    <h1 className="text-center text-white text-4xl md:text-5xl font-bold leading-tight">
                        ...
                        Security Services in Queens County, New York          </h1>
                </div>
            </section>
                    ...
                    <div className="grid lg:grid-cols-4 gap-10">
                        ...
                        <div className="lg:col-span-3">
                            ...
                            <h2 className="text-3xl  text-center font-bold leading-tight mb-12">
                                ...
                                <span className="text-red-500">Queens</span>
                                <br />
                                County
                            </h2>
                            ...
                            <p className="text-gray-600 leading-8 mb-12">
                                Queens County requires reliable security services for residential and commercial clients. Security Guardian offers licensed armed and unarmed guards, mobile patrols, and event security for maximum safety and peace of mind.                            </p>
