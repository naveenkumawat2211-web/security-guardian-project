...
import newyorkBanner from '../../assets/Locations/new-york.jpg'
            ...
            <section className="relative h-[520px] overflow-hidden">
                ...
                <div data-aos="zoom-in" className="relative z-10 flex items-center justify-center h-full px-5">
                    <h1 className="text-center text-white text-4xl md:text-5xl font-bold leading-tight">
                        ...
                        Security Services in New York County, New York  </h1>
                </div>
            </section>
                    ...
                    <div className="grid lg:grid-cols-4 gap-10">
                        ...
                        <div className="lg:col-span-3">
                            ...
                            <p className="text-gray-600 leading-8 mb-12">
                                Albany County is a thriving region with residential and commercial areas that require professional security solutions. Security Guardian provides licensed armed and unarmed guards, mobile patrol, and corporate security to protect people and property effectively.
                            </p>
...
">
                                    ...
                                    <div className="border-l-4 border-white pl-8">
                                        <p className="pl-2">
                                            Ensure your safety and peace of mind with Security Guardian in Albany County!
                                        </p>
                                    </div>
