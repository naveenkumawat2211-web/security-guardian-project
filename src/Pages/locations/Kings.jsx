...
import kingsBanner from '../../assets/Locations/kings.jpg'
            ...
            <section className="relative h-[520px] overflow-hidden">
                ...
                <div data-aos="zoom-in" className="relative z-10 flex items-center justify-center h-full px-5">
                    <h1 className="text-center text-white text-4xl md:text-5xl font-bold leading-tight">
                        ...
                        Security Services in Kings County, New York          </h1>
                </div>
            </section>
                    ...
                    <div className="grid lg:grid-cols-4 gap-10">
                        ...
                        <div className="lg:col-span-3">
                            ...
                            <p className="text-gray-600 leading-8 mb-12">
                                Kings County requires professional security solutions for residential, commercial, and corporate clients. Security Guardian delivers licensed armed and unarmed guards, mobile patrols, and specialized event security.                            </p>
