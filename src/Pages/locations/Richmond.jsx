...
import richmondBanner from '../../assets/Locations/richmond.jpg'
            ...
            <section className="relative h-[520px] overflow-hidden">
                ...
                <div data-aos="zoom-in" className="relative z-10 flex items-center justify-center h-full px-5">
                    <h1 className="text-center text-white text-4xl md:text-5xl font-bold leading-tight">
                        ...
                        Security Services in Richmond County, New York          </h1>
                </div>
            </section>
                    ...
                    <div className="grid lg:grid-cols-4 gap-10">
                        ...
                        <div className="lg:col-span-3">
                            ...
                            <h2 className="text-3xl  text-center font-bold leading-tight mb-12">
                                ...
                                <span className="text-red-500">Richmond</span>
                                <br />
                                County
                            </h2>
                            ...
                            <p className="text-gray-600 leading-8 mb-12">
                                Richmond County has diverse residential and commercial areas that require professional security solutions. Security Guardian provides licensed armed and unarmed guards, mobile patrols, and event security to ensure safety and protection.                            </p>
