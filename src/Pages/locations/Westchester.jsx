...
import westchesterBanner from '../../assets/Locations/westchester.jpg'
import { Link } from 'react-router-dom'


export default function Westchester() {
    return (
        <>
            <section className="relative h-[520px] overflow-hidden">
                {/* Background Image */}
                <img
                    src={westchesterBanner}
                ...
                <div data-aos="zoom-in" className="relative z-10 flex items-center justify-center h-full px-5">
                    <h1 className="text-center text-white text-4xl md:text-5xl font-bold leading-tight">
                        ...
                        Security Services in Westchester County, New York          </h1>
                </div>
            </section>
                    ...
                    <div className="grid lg:grid-cols-4 gap-10">
                        ...
                        <div className="lg:col-span-3">
                            ...
                            <h2 className="text-3xl  text-center font-bold leading-tight mb-12">
                                ...
                                <span className="text-red-500">Westchester</span>
                                <br />
                                County
                            </h2>
                            ...
                            <p className="text-gray-600 leading-8 mb-12">
                                Westchester County features residential neighborhoods, corporate offices, and commercial spaces that require professional security. Security Guardian offers licensed armed and unarmed guards, mobile patrol, and corporate security to ensure comprehensive protection.                            </p>
